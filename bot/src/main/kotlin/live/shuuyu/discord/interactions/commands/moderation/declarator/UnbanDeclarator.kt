...
import live.shuuyu.discord.interactions.commands.moderation.UnbanExecutor
...
class UnbanDeclarator(val nabi: NabiCore): SlashCommandDeclarationWrapper {
    companion object {
        val i18n = LanguageManager("./locale/commands/Unban.toml")
    }
